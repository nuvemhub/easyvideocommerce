(function () {
  ...
  const ramdomParam = `&t=${Math.random().toString(36).substring(2, 15)}`;

  if (debug) {
    s.src = `https://cdn.jsdelivr.net/gh/nuvemhub/easyvideocommerce@debug/dist/nuvemHubEVCEmbbed.min.js?storeId=${storeId}&vapp=${scriptVersion}${ramdomParam}`;
