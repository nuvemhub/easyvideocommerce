...
var easyDataLayer = {
  ...
  getEasyCampaigns: function () {
    return new Promise((resolve) => {
      const query = `storeId=${easyDataLayer.config.storeId}&filter=${encodeURIComponent(window.location.pathname)}`;

      fetch(`${easyDataLayer.config.apiUrl}/campaign/list/display?${query}`)
